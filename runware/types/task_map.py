"""
AUTO-GENERATED from runware schemas v20260730181327 — do not edit manually.
...
SCHEMAS_VERSION = "20260730181327"
...
class Reve21Params(TypedDict, total=False):
    """Inference params for curated model `reve:2@1` (slug: reve-2-1)."""

    model: Literal['reve:2@1']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class Reve21Result(TypedDict, total=False):
    """Inference result for curated model `reve:2@1` (slug: reve-2-1)."""
...
models: dict[str, ModelEntry] = {
    ...
    "reve:2@1": ModelEntry(task_type="imageInference", id="reve-2-1"),
