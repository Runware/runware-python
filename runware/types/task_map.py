"""
AUTO-GENERATED from runware schemas v20260903174949 — do not edit manually.
...
SCHEMAS_VERSION = "20260903174949"
...
class MinimaxH3Params(TypedDict, total=False):
    """Inference params for curated model `minimax:h3@0` (slug: minimax-h3)."""

    model: Literal['minimax:h3@0']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
    resolution: NotRequired[Literal['768p', '1440p']]
...
class MinimaxH3Result(TypedDict, total=False):
    """Inference result for curated model `minimax:h3@0` (slug: minimax-h3)."""
...
class MinimaxH3MaxParams(TypedDict, total=False):
    """Inference params for curated model `minimax:h3@max` (slug: minimax-h3-max)."""

    model: Literal['minimax:h3@max']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
    resolution: NotRequired[Literal['480p', '768p']]
    duration: NotRequired[int]
    seed: NotRequired[int]
    taskType: Literal['videoInference']
    taskUUID: str
...
class MinimaxH3MaxResult(TypedDict, total=False):
    """Inference result for curated model `minimax:h3@max` (slug: minimax-h3-max)."""
...
class RunwareFlux2Klein4bStyleLoraTrainingParams(TypedDict, total=False):
    """Inference params for curated model `runware:flux-2-klein-4b@style-lora-training` (slug: runware-flux-2-klein-4b-style-lora-training)."""

    model: Literal['runware:flux-2-klein-4b@style-lora-training']
    inputs: dict[str, object]
...
class RunwareFlux2Klein4bStyleLoraTrainingResult(TypedDict, total=False):
    """Inference result for curated model `runware:flux-2-klein-4b@style-lora-training` (slug: runware-flux-2-klein-4b-style-lora-training)."""
...
class ContentSafetyParams(TypedDict, total=False):
    """Inference params for curated model `runware:content-safety@1` (slug: content-safety)."""

    model: Literal['runware:content-safety@1']
    deliveryMethod: NotRequired[str]
    inputs: dict[str, object]
    settings: NotRequired[dict[str, object]]
    taskType: Literal['caption']
...
class ContentSafetyResult(TypedDict, total=False):
    """Inference result for curated model `runware:content-safety@1` (slug: content-safety)."""
...
class RunwareFlux2Klein9bStyleLoraTrainingParams(TypedDict, total=False):
    """Inference params for curated model `runware:flux-2-klein-9b@style-lora-training` (slug: runware-flux-2-klein-9b-style-lora-training)."""

    model: Literal['runware:flux-2-klein-9b@style-lora-training']
    inputs: dict[str, object]
    importModel: dict[str, object]
    learningRate: NotRequired[float]
    trainingSteps: NotRequired[int]
...
class RunwareFlux2Klein9bStyleLoraTrainingResult(TypedDict, total=False):
    """Inference result for curated model `runware:flux-2-klein-9b@style-lora-training` (slug: runware-flux-2-klein-9b-style-lora-training)."""
...
class TopazlabsWonder35Params(TypedDict, total=False):
    """Inference params for curated model `topazlabs:wonder@3.5` (slug: topazlabs-wonder-3-5)."""

    model: Literal['topazlabs:wonder@3.5']
...
class TopazlabsWonder35Result(TypedDict, total=False):
    """Inference result for curated model `topazlabs:wonder@3.5` (slug: topazlabs-wonder-3-5)."""
...
class TopazlabsProteus4Params(TypedDict, total=False):
    """Inference params for curated model `topazlabs:proteus@4` (slug: topazlabs-proteus-4)."""

    model: Literal['topazlabs:proteus@4']
    width: int
    height: int
    fps: NotRequired[float]
    settings: NotRequired[dict[str, object]]
...
class TopazlabsProteus4Result(TypedDict, total=False):
    """Inference result for curated model `topazlabs:proteus@4` (slug: topazlabs-proteus-4)."""
...
class PrunaaiPImageIdeogramParams(TypedDict, total=False):
    """Inference params for curated model `prunaai:p-image@ideogram` (slug: prunaai-p-image-ideogram)."""

    model: Literal['prunaai:p-image@ideogram']
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
    seed: NotRequired[int]
...
class PrunaaiPImageIdeogramResult(TypedDict, total=False):
    """Inference result for curated model `prunaai:p-image@ideogram` (slug: prunaai-p-image-ideogram)."""
...
class PrunaaiPVideoEditParams(TypedDict, total=False):
    """Inference params for curated model `prunaai:p-video@edit` (slug: prunaai-p-video-edit)."""

    model: Literal['prunaai:p-video@edit']
    inputs: dict[str, object]
    positivePrompt: str
    seed: NotRequired[int]
    settings: NotRequired[dict[str, object]]
...
class PrunaaiPVideoEditResult(TypedDict, total=False):
    """Inference result for curated model `prunaai:p-video@edit` (slug: prunaai-p-video-edit)."""
...
class RecraftV4StylesProParams(TypedDict, total=False):
    """Inference params for curated model `recraft:v4@styles-pro` (slug: recraft-v4-styles-pro)."""

    model: Literal['recraft:v4@styles-pro']
    inputs: dict[str, object]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class RecraftV4StylesProResult(TypedDict, total=False):
    """Inference result for curated model `recraft:v4@styles-pro` (slug: recraft-v4-styles-pro)."""
...
class RecraftV4StylesProVectorParams(TypedDict, total=False):
    """Inference params for curated model `recraft:v4@styles-pro-vector` (slug: recraft-v4-styles-pro-vector)."""

    model: Literal['recraft:v4@styles-pro-vector']
    inputs: dict[str, object]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class RecraftV4StylesProVectorResult(TypedDict, total=False):
    """Inference result for curated model `recraft:v4@styles-pro-vector` (slug: recraft-v4-styles-pro-vector)."""
...
class RecraftV4StylesParams(TypedDict, total=False):
    """Inference params for curated model `recraft:v4@styles` (slug: recraft-v4-styles)."""

    model: Literal['recraft:v4@styles']
    inputs: dict[str, object]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class RecraftV4StylesResult(TypedDict, total=False):
    """Inference result for curated model `recraft:v4@styles` (slug: recraft-v4-styles)."""
...
class RecraftV4StylesVectorParams(TypedDict, total=False):
    """Inference params for curated model `recraft:v4@styles-vector` (slug: recraft-v4-styles-vector)."""

    model: Literal['recraft:v4@styles-vector']
    inputs: dict[str, object]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class RecraftV4StylesVectorResult(TypedDict, total=False):
    """Inference result for curated model `recraft:v4@styles-vector` (slug: recraft-v4-styles-vector)."""
...
class AlibabaWan30Params(TypedDict, total=False):
    """Inference params for curated model `alibaba:wan@3.0` (slug: alibaba-wan3-0)."""

    model: Literal['alibaba:wan@3.0']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: NotRequired[str]
    width: NotRequired[int]
    height: NotRequired[int]
...
class AlibabaWan30Result(TypedDict, total=False):
    """Inference result for curated model `alibaba:wan@3.0` (slug: alibaba-wan3-0)."""
...
class AlibabaQwenImage30Params(TypedDict, total=False):
    """Inference params for curated model `alibaba:qwen-image@3.0` (slug: alibaba-qwen-image-3-0)."""

    model: Literal['alibaba:qwen-image@3.0']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    negativePrompt: NotRequired[str]
    width: NotRequired[int]
...
class AlibabaQwenImage30Result(TypedDict, total=False):
    """Inference result for curated model `alibaba:qwen-image@3.0` (slug: alibaba-qwen-image-3-0)."""
...
class AlibabaWan30PrimeParams(TypedDict, total=False):
    """Inference params for curated model `alibaba:wan@3.0-prime` (slug: alibaba-wan3-0-prime)."""

    model: Literal['alibaba:wan@3.0-prime']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: NotRequired[str]
    width: NotRequired[int]
    height: NotRequired[int]
...
class AlibabaWan30PrimeResult(TypedDict, total=False):
    """Inference result for curated model `alibaba:wan@3.0-prime` (slug: alibaba-wan3-0-prime)."""
...
class AlibabaQwenImageEdit2511Params(TypedDict, total=False):
    """Inference params for curated model `alibaba:qwen-image-edit@2511` (slug: alibaba-qwen-image-edit-2511)."""

    model: Literal['alibaba:qwen-image-edit@2511']
    inputs: dict[str, object]
    positivePrompt: str
    negativePrompt: NotRequired[str]
    width: NotRequired[int]
...
class AlibabaQwenImageEdit2511Result(TypedDict, total=False):
    """Inference result for curated model `alibaba:qwen-image-edit@2511` (slug: alibaba-qwen-image-edit-2511)."""
...
class AlibabaQwenImage30ProParams(TypedDict, total=False):
    """Inference params for curated model `alibaba:qwen-image@3.0-pro` (slug: alibaba-qwen-image-3-0-pro)."""

    model: Literal['alibaba:qwen-image@3.0-pro']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    negativePrompt: NotRequired[str]
    width: NotRequired[int]
...
class AlibabaQwenImage30ProResult(TypedDict, total=False):
    """Inference result for curated model `alibaba:qwen-image@3.0-pro` (slug: alibaba-qwen-image-3-0-pro)."""
...
class IdeogramRemoveBackgroundParams(TypedDict, total=False):
    """Inference params for curated model `ideogram:remove-background@0` (slug: ideogram-remove-background)."""

    model: Literal['ideogram:remove-background@0']
    taskType: Literal['removeBackground']
    taskUUID: str
    webhookURL: NotRequired[str]
    includeCost: NotRequired[bool]
...
class IdeogramRemoveBackgroundResult(TypedDict, total=False):
    """Inference result for curated model `ideogram:remove-background@0` (slug: ideogram-remove-background)."""
...
class Ideogram40qParams(TypedDict, total=False):
    """Inference params for curated model `ideogram:4@q` (slug: ideogram-4-0q)."""

    model: Literal['ideogram:4@q']
    positivePrompt: NotRequired[str]
    negativePrompt: NotRequired[str]
    width: NotRequired[int]
    height: NotRequired[int]
...
class Ideogram40qResult(TypedDict, total=False):
    """Inference result for curated model `ideogram:4@q` (slug: ideogram-4-0q)."""
...
class IdeogramObjectRemoverParams(TypedDict, total=False):
    """Inference params for curated model `ideogram:object-remover@0` (slug: ideogram-object-remover)."""

    model: Literal['ideogram:object-remover@0']
    inputs: dict[str, object]
    seed: NotRequired[int]
    taskType: Literal['imageInference']
    taskUUID: str
...
class IdeogramObjectRemoverResult(TypedDict, total=False):
    """Inference result for curated model `ideogram:object-remover@0` (slug: ideogram-object-remover)."""
...
class XaiGrokImagineImage20Params(TypedDict, total=False):
    """Inference params for curated model `xai:grok-imagine@image-2.0` (slug: xai-grok-imagine-image-2-0)."""

    model: Literal['xai:grok-imagine@image-2.0']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class XaiGrokImagineImage20Result(TypedDict, total=False):
    """Inference result for curated model `xai:grok-imagine@image-2.0` (slug: xai-grok-imagine-image-2-0)."""
...
class BytedanceSeedance25Params(TypedDict, total=False):
    """Inference params for curated model `bytedance:seedance@2.5` (slug: bytedance-seedance-2-5)."""

    model: Literal['bytedance:seedance@2.5']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: NotRequired[str]
    width: NotRequired[int]
    height: NotRequired[int]
...
class BytedanceSeedance25Result(TypedDict, total=False):
    """Inference result for curated model `bytedance:seedance@2.5` (slug: bytedance-seedance-2-5)."""
...
class Sync3Params(TypedDict, total=False):
    """Inference params for curated model `sync:3@0` (slug: sync-3)."""

    model: Literal['sync:3@0']
    inputs: dict[str, object]
    settings: NotRequired[dict[str, object]]
    taskType: Literal['videoInference']
    taskUUID: str
...
class Sync3Result(TypedDict, total=False):
    """Inference result for curated model `sync:3@0` (slug: sync-3)."""
...
class Krea2MediumTurboParams(TypedDict, total=False):
    """Inference params for curated model `krea:krea@2-medium-turbo` (slug: krea-2-medium-turbo)."""

    model: Literal['krea:krea@2-medium-turbo']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: int
    height: int
...
class Krea2MediumTurboResult(TypedDict, total=False):
    """Inference result for curated model `krea:krea@2-medium-turbo` (slug: krea-2-medium-turbo)."""
...
class Krea2RawParams(TypedDict, total=False):
    """Inference params for curated model `krea:krea@2-raw` (slug: krea-2-raw)."""

    model: Literal['krea:krea@2-raw']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    negativePrompt: NotRequired[str]
    width: int
...
class Krea2RawResult(TypedDict, total=False):
    """Inference result for curated model `krea:krea@2-raw` (slug: krea-2-raw)."""
...
class BflFlux3VideoParams(TypedDict, total=False):
    """Inference params for curated model `bfl:flux@3-video` (slug: bfl-flux-3-video)."""

    model: Literal['bfl:flux@3-video']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: NotRequired[str]
    width: NotRequired[int]
    height: NotRequired[int]
...
class BflFlux3VideoResult(TypedDict, total=False):
    """Inference result for curated model `bfl:flux@3-video` (slug: bfl-flux-3-video)."""
...
class BflFluxVideoUpscaleParams(TypedDict, total=False):
    """Inference params for curated model `bfl:flux@video-upscale` (slug: bfl-flux-video-upscale)."""

    model: Literal['bfl:flux@video-upscale']
    inputs: dict[str, object]
    positivePrompt: NotRequired[str]
    upscaleFactor: NotRequired[float]
    settings: NotRequired[dict[str, object]]
...
class BflFluxVideoUpscaleResult(TypedDict, total=False):
    """Inference result for curated model `bfl:flux@video-upscale` (slug: bfl-flux-video-upscale)."""
...
class MetaMuseImageParams(TypedDict, total=False):
    """Inference params for curated model `meta:muse@image` (slug: meta-muse-image)."""

    model: Literal['meta:muse@image']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
    resolution: NotRequired[Literal['2K']]
    settings: NotRequired[dict[str, object]]
    taskType: Literal['imageInference']
    taskUUID: str
    webhookURL: NotRequired[str]
...
class MetaMuseImageResult(TypedDict, total=False):
    """Inference result for curated model `meta:muse@image` (slug: meta-muse-image)."""
...
class RundiffusionJuggernautZFastParams(TypedDict, total=False):
    """Inference params for curated model `rundiffusion:300@100` (slug: rundiffusion-juggernaut-z-fast)."""

    model: Literal['rundiffusion:300@100']
    steps: NotRequired[int]
    scheduler: NotRequired[Literal['DDIM', 'DDIMScheduler', 'DDPMScheduler', 'DEISMultistepScheduler', 'Default', 'DPM++', 'DPM++ 2M', 'DPM++ 2M Beta', 'DPM++ 2M Exponential', 'DPM++ 2M Karras', 'DPM++ 2M SDE', 'DPM++ 2M SDE Beta', 'DPM++ 2M SDE Exponential', 'DPM++ 2M SDE Karras', 'DPM++ 2M SDE Uniform', 'DPM++ 2M Uniform', 'DPM++ 3M', 'DPM++ 3M Beta', 'DPM++ 3M Exponential', 'DPM++ 3M Karras', 'DPM++ 3M SDE Uniform', 'DPM++ 3M Uniform', 'DPM++ Beta', 'DPM++ Exponential', 'DPM++ Karras', 'DPM++ SDE', 'DPM++ SDE Beta', 'DPM++ SDE Exponential', 'DPM++ SDE Karras', 'DPM++ Uniform', 'DPM++ Uniform Beta', 'DPM++ Uniform Exponential', 'DPM++ Uniform Karras', 'DPMSolverMultistepInverse', 'DPMSolverMultistepScheduler', 'DPMSolverSinglestepScheduler', 'EDMDPMSolverMultistepScheduler', 'EDMEulerScheduler', 'Euler', 'Euler a', 'Euler Beta', 'Euler Exponential', 'Euler Karras', 'EulerAncestralDiscreteScheduler', 'EulerDiscreteScheduler', 'FlowMatchEulerDiscreteScheduler', 'Heun', 'HeunDiscreteScheduler', 'Heun Karras', 'IPNDMScheduler', 'IPNDM Uniform', 'IPNDM Uniform Beta', 'IPNDM Uniform Exponential', 'IPNDM Uniform Karras', 'KDPM2AncestralDiscreteScheduler', 'KDPM2DiscreteScheduler', 'LCM', 'LCMScheduler', 'LMS', 'LMSDiscreteScheduler', 'LMS Karras', 'PNDMScheduler', 'TCDScheduler', 'UniPC', 'UniPC 2M', 'UniPC 2M Karras', 'UniPC 2M Uniform', 'UniPC 3M', 'UniPC 3M Karras', 'UniPC 3M Uniform', 'UniPC Karras', 'UniPC Uniform', 'UniPC Uniform Beta', 'UniPC Uniform Exponential', 'UniPC Uniform Karras']]
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
...
class RundiffusionJuggernautZFastResult(TypedDict, total=False):
    """Inference result for curated model `rundiffusion:300@100` (slug: rundiffusion-juggernaut-z-fast)."""
...
class GoogleGeminiOmniFlash11Params(TypedDict, total=False):
    """Inference params for curated model `google:gemini@omni-flash-1.1` (slug: google-gemini-omni-flash-1-1)."""

    model: Literal['google:gemini@omni-flash-1.1']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
    resolution: NotRequired[Literal['360p', '720p', '1080p', '4K']]
    duration: NotRequired[int]
    settings: NotRequired[dict[str, object]]
    taskType: Literal['videoInference']
    taskUUID: str
...
class GoogleGeminiOmniFlash11Result(TypedDict, total=False):
    """Inference result for curated model `google:gemini@omni-flash-1.1` (slug: google-gemini-omni-flash-1-1)."""
...
class BriaVideoBackgroundRemovalParams(TypedDict, total=False):
    ...
    outputQuality: NotRequired[int]
    outputType: NotRequired[Literal['URL']]
    outputFormat: NotRequired[Literal['WEBM', 'MOV']]
    deliveryMethod: NotRequired[str]
    inputs: dict[str, object]
...
class LightricksLtx25FastParams(TypedDict, total=False):
    """Inference params for curated model `lightricks:ltx@2.5-fast` (slug: lightricks-ltx-2-5-fast)."""

    model: Literal['lightricks:ltx@2.5-fast']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class LightricksLtx25FastResult(TypedDict, total=False):
    """Inference result for curated model `lightricks:ltx@2.5-fast` (slug: lightricks-ltx-2-5-fast)."""
...
class LightricksLtx25ProParams(TypedDict, total=False):
    """Inference params for curated model `lightricks:ltx@2.5-pro` (slug: lightricks-ltx-2-5-pro)."""

    model: Literal['lightricks:ltx@2.5-pro']
    inputs: NotRequired[dict[str, object]]
    positivePrompt: str
    width: NotRequired[int]
    height: NotRequired[int]
...
class LightricksLtx25ProResult(TypedDict, total=False):
    """Inference result for curated model `lightricks:ltx@2.5-pro` (slug: lightricks-ltx-2-5-pro)."""
...
models: dict[str, ModelEntry] = {
    ...
    "alibaba:qwen-image-edit@2511": ModelEntry(task_type="imageInference", id="alibaba-qwen-image-edit-2511"),
    ...
    "alibaba:qwen-image@3.0": ModelEntry(task_type="imageInference", id="alibaba-qwen-image-3-0"),
    "alibaba:qwen-image@3.0-pro": ModelEntry(task_type="imageInference", id="alibaba-qwen-image-3-0-pro"),
    ...
    "alibaba:wan@3.0": ModelEntry(task_type="videoInference", id="alibaba-wan3-0"),
    "alibaba:wan@3.0-prime": ModelEntry(task_type="videoInference", id="alibaba-wan3-0-prime"),
    ...
    "bfl:flux@3-video": ModelEntry(task_type="videoInference", id="bfl-flux-3-video"),
    ...
    "bfl:flux@video-upscale": ModelEntry(task_type="upscale", id="bfl-flux-video-upscale"),
    ...
    "bytedance:seedance@2.5": ModelEntry(task_type="videoInference", id="bytedance-seedance-2-5"),
    ...
    "google:gemini@omni-flash-1.1": ModelEntry(task_type="videoInference", id="google-gemini-omni-flash-1-1"),
    ...
    "ideogram:4@q": ModelEntry(task_type="imageInference", id="ideogram-4-0q"),
    ...
    "ideogram:object-remover@0": ModelEntry(task_type="imageInference", id="ideogram-object-remover"),
    "ideogram:remove-background@0": ModelEntry(task_type="removeBackground", id="ideogram-remove-background"),
    ...
    "krea:krea@2-medium-turbo": ModelEntry(task_type="imageInference", id="krea-2-medium-turbo"),
    "krea:krea@2-raw": ModelEntry(task_type="imageInference", id="krea-2-raw"),
    ...
    "lightricks:ltx@2.5-fast": ModelEntry(task_type="videoInference", id="lightricks-ltx-2-5-fast"),
    "lightricks:ltx@2.5-pro": ModelEntry(task_type="videoInference", id="lightricks-ltx-2-5-pro"),
    ...
    "meta:muse@image": ModelEntry(task_type="imageInference", id="meta-muse-image"),
    ...
    "minimax:h3@0": ModelEntry(task_type="videoInference", id="minimax-h3"),
    "minimax:h3@max": ModelEntry(task_type="videoInference", id="minimax-h3-max"),
    ...
    "prunaai:p-image@ideogram": ModelEntry(task_type="imageInference", id="prunaai-p-image-ideogram"),
    ...
    "prunaai:p-video@edit": ModelEntry(task_type="videoInference", id="prunaai-p-video-edit"),
    ...
    "recraft:v4@styles": ModelEntry(task_type="imageInference", id="recraft-v4-styles"),
    "recraft:v4@styles-pro": ModelEntry(task_type="imageInference", id="recraft-v4-styles-pro"),
    "recraft:v4@styles-pro-vector": ModelEntry(task_type="vectorize", id="recraft-v4-styles-pro-vector"),
    "recraft:v4@styles-vector": ModelEntry(task_type="vectorize", id="recraft-v4-styles-vector"),
    ...
    "rundiffusion:300@100": ModelEntry(task_type="imageInference", id="rundiffusion-juggernaut-z-fast"),
    ...
    "runware:content-safety@1": ModelEntry(task_type="caption", id="content-safety"),
    ...
    "runware:flux-2-klein-4b@style-lora-training": ModelEntry(task_type="training", id="runware-flux-2-klein-4b-style-lora-training"),
    "runware:flux-2-klein-9b@style-lora-training": ModelEntry(task_type="training", id="runware-flux-2-klein-9b-style-lora-training"),
    ...
    "sync:3@0": ModelEntry(task_type="videoInference", id="sync-3"),
    ...
    "topazlabs:proteus@4": ModelEntry(task_type="upscale", id="topazlabs-proteus-4"),
    "topazlabs:starlight-precise@2.5": ModelEntry(task_type="upscale", id="topazlabs-starlight-precise-2-5"),
    "topazlabs:wonder@3.5": ModelEntry(task_type="upscale", id="topazlabs-wonder-3-5"),
    ...
    "xai:grok-imagine@image-2.0": ModelEntry(task_type="imageInference", id="xai-grok-imagine-image-2-0"),
